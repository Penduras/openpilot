...
# xnor: pfeiferj/openpilot-mapd v2 protocol, schema copied verbatim from
# https://github.com/pfeiferj/openpilot-mapd/blob/v2.1.0/cereal/custom/custom.capnp
# (only the 3 reserved-ID structs plus their auxiliary types actually used).
...
# WARNING: must be kept in perfect sync (names and values) with mapd's own
# HighwayClass enum - mapd casts directly between the two generated enum types.
enum HighwayClass {
  unknown @0;
  motorway @1;
  motorwayLink @2;
