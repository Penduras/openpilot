...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    # Moved here (was right before the old self.mpc.update(..., v_cruise, ...) call) during
    # the xnor-dev resync merge (2026-08-15) - upstream's "move cruise speed limit out of
    # the MPC" (#38367) relocated where v_cruise actually gets consumed to this
    # get_cruise_accel() call, so the cap has to apply before this call now instead.
