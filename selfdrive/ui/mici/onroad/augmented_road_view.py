...
class AugmentedRoadView(CameraView):
  def __init__(self, bookmark_callback=None, stream_type: VisionStreamType = VisionStreamType.VISION_STREAM_ROAD):
    ...
    self._scc_map_badge = SccBadge("M", "SmartCruiseControlMap", "mapCurveSpeed", clock_hour=10)
    self._scc_vision_badge = SccBadge("V", "SmartCruiseControlVision", "visionCurveSpeed", clock_hour=2)
