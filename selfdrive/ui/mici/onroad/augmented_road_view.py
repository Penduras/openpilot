...
class AugmentedRoadView(CameraView):
  def __init__(self, bookmark_callback=None, stream_type: VisionStreamType = VisionStreamType.VISION_STREAM_ROAD):
    ...
    self._scc_map_badge = SccBadge("SCC-M", "SmartCruiseControlMap", "mapCurveSpeed", slot=0)
    self._scc_vision_badge = SccBadge("SCC-V", "SmartCruiseControlVision", "visionCurveSpeed", slot=1)
